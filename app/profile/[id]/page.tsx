      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center">
            ...
            <div className="relative mx-auto mb-4 h-32 w-32 overflow-hidden rounded-full border-2 border-purple-500 shadow-md">
              {previewImage && (
                <Image
                  src={previewImage}
                  alt="Profile Preview"
            ...
            <label
              ...
              className="inline-flex cursor-pointer items-center justify-center rounded-full border border-purple-500 bg-purple-50 px-4 py-2 font-semibold text-purple-700 transition-colors hover:bg-purple-100"
            >
              เลือกรูปภาพใหม่
            </label>
            <input
          ...
          <div className="flex justify-between space-x-4">
            <Link href={"/dashboard/" + id} className="w-1/2">
              <div className="transform rounded-full border border-purple-300 bg-white py-2.5 text-center font-semibold text-purple-700 shadow-md transition-all duration-300 hover:scale-105 hover:bg-purple-50">
                ย้อนกลับ
              </div>
            </Link>
            <button
